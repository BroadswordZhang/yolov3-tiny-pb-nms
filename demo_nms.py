...
tf.app.flags.DEFINE_string(
    'input_img', "./416_416.jpg", 'Input image')
tf.app.flags.DEFINE_string(
    'output_img', 'result.jpg', 'Output image')
tf.app.flags.DEFINE_string(
    'class_names', './sur/sur1230/sur1229.names', 'File with class names')
tf.app.flags.DEFINE_string(
...
tf.app.flags.DEFINE_string(
    'frozen_model', './sur/sur1230/yolov3_tiny_sur.pb', 'Frozen tensorflow protobuf model')
