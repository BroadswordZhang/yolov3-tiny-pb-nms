...
from yolo_v3 import _conv2d_fixed_padding, _fixed_padding, _get_size,_upsample
        ...
        with slim.arg_scope([slim.conv2d, slim.batch_norm, _fixed_padding], reuse=reuse):
            with slim.arg_scope([slim.conv2d],
                ...
                with tf.variable_scope('yolo-v3-tiny'):
                    ...
                    detect_1 = tf.reshape(detect_1, (1, 13, 13, 3, 6),name = 'detect_1')
...
de
                    ...
                    detect_2 = tf.reshape(detect_2, (1, 26, 26, 3, 6),name = 'detect_2')


                    return detect_1,detect_2
